"""
SettingsStackTile - Tile widget for the settings icon.

Displays ajustes.svg icon as a stack tile, always positioned at the rightmost position.
"""
...
class SettingsStackTile(QWidget):
    ...
    def __init__(
        ...
        """Initialize settings stack tile."""
    ...
    def _add_icon_zone(self, layout: QVBoxLayout) -> None:
        ...
        # Cargar el SVG ajustes.svg
        pixmap = render_svg_icon("ajustes.svg", QSize(icon_width, icon_height))
