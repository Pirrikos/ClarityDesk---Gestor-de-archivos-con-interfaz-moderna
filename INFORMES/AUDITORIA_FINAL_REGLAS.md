...
1. ❌ **`app/managers/files_manager.py`** (línea 15):
   ...
   **Solución:** Mover `open_file_with_system()` a `app/services/file_open_service.py`
...
2. ❌ **`app/services/icon_service.py`** (línea 18):
   ...
   **Solución:** Mover `icon_fallback_helper.py` a `app/services/`
...
- ⚠️ **Carpeta residual:** `app/controllers/` (solo __pycache__)
...
**Paso 1.1:** Crear `app/services/file_open_service.py`
- Mover función `open_file_with_system()` desde `main_window_file_handler.py`
- Mantener `filter_previewable_files()` en `main_window_file_handler.py` (es específica de UI)

**Paso 1.2:** Mover `icon_fallback_helper.py`
- Mover de `app/ui/widgets/icon_fallback_helper.py` a `app/services/icon_fallback_helper.py`
- Actualizar import en `icon_service.py`

**Paso 1.3:** Actualizar imports
- `files_manager.py`: Cambiar import a `app.services.file_open_service`
- `icon_service.py`: Cambiar import a `app.services.icon_fallback_helper`
- Verificar otros archivos que importen estos módulos
